Feature: Annotate events in splicing data
	...
	Scenario Outline: Annotate events in cortar data using RefSeq MANE Select Annotations
		...
		Examples:
			...
			| 7    | chr9  | 34647259 | 34647474 | +      | sj   | NM_000155.4    | intronic cryptic acceptor @ -17                        | 2      | galt_intron_1_merged_sjir_12 | cryptic acceptor intronic +                                                                         |
			| 8    | chr9  | 34647259 | 34648091 | +      | sj   | NM_000155.4    | exon 3-4-5 skipping/intronic cryptic acceptor @ -23    | 2      | galt_intron_1_merged_sjir_7  | cryptic acceptor with skipping +                                                                    |
			| 9    | chr9  | 34647259 | 34648047 | +      | sj   | NM_000155.4    | exon 3-4-5 skipping/intronic cryptic acceptor @ -67    | 2      | galt_intron_1_merged_sjir_8  | cryptic acceptor with skipping +                                                                    |
